import {calcDistance} from './euclidean.js';
...
function success(pos) {
  ...
  const location = [crd.longitude, crd.latitude];

  restaurants.sort((a, b) => {
    return (
      calcDistance(location, a.location.coordinates) -
      calcDistance(location, b.location.coordinates)
    );
  });
